...
let intersectionPoint = edge.intersectsEdge(otherEdge);
console.assert(arrayEquals(intersectionPoint, [4, 0]), "Edge intersects edge at [4,0]");
...
let triangleEdge;
[triangleEdge, intersectionPoint] = triangle.intersectsEdge(intersectingEdge);
